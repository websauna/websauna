...
def contribute_model_admin(event):
    ...
    for id_, model_admin in model_admin_root.items():
        entry = menu.TraverseEntry("admin-menu-data-{0}".format(id_), label=model_admin.title, resource=model_admin, name="listing")
