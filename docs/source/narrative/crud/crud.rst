...
Schema entry points are

* :py:attr:`websauna.system.crud.views.FormView.includes` attribute describing the fields to be included on the autogenerated form

* :py:meth:`websauna.system.crud.views.FormView.customize_schema` to change form schema dynamically after creation

* :py:meth:`websauna.system.crud.views.FormView.create_form` which is responsible for constructing :term:`Colander` schema and :term:`Deform` form for the view in the first place
...
* :ref:`overriding listing view in admin example <override-listing>`.
