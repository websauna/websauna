...
class CRUD:
    ...
    def __init__(self):
        ...
        traverse.make_lineage(self, self.edit, "edit")
        traverse.make_lineage(self, self.add, "add")
        traverse.make_lineage(self, self.view, "view")
        traverse.make_lineage(self, self.delete, "delete")
    ...
    def __getitem__(self, name):
        if name == "listing":
            ...
            return self.add
        raise KeyError("Unknown view {} for CRUD {}".format(name, self))
